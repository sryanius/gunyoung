...
const { default: BattleScene } = await import(new URL('./BattleScene.mjs', import.meta.url).href);
const { default: BattleHud } = await import(new URL('./BattleHud.mjs', import.meta.url).href);
