...
const { default: BattleScene } = await import(new URL('./_fix/BattleScene.mjs', import.meta.url).href);
const { default: BattleHud } = await import(new URL('./_fix/BattleHud.mjs', import.meta.url).href);
